...
export default function SeoServicesPage({ onBackToHome }: SeoServicesPageProps) {
  ...
  const WHATSAPP_LINK = 'https://wa.me/918318114492?text=Hello%20AKGLS%20Group%2C%20I%20want%20to%20get%20started%20with%20your%20SEO%20Services.';
  ...
  return (
    <div className="bg-[#05070a] text-slate-300 min-h-screen">
      ...
      <section className="relative pt-6 pb-16 sm:pt-8 md:pt-10 md:pb-24 bg-[#05070a] text-white overflow-hidden text-left border-b border-slate-900/60">
        ...
        <div className="absolute top-0 inset-x-0 h-24 bg-gradient-to-b from-brand-orange/10 via-brand-indigo/5 to-transparent pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 bg-slate-950 rounded-2xl border border-slate-850 p-6 flex flex-col justify-between">
              ...
              <div className="pt-6 border-t border-slate-900 mt-6 flex justify-end">
                <a 
                  href={`${WHATSAPP_BASE}?text=I%20want%20to%20consult%20on%20${encodeURIComponent(servicesData[activeServiceTab as keyof typeof servicesData].title)}.%20Please%20share%20proposal.`}
                  target="_blank"
                  referrerPolicy="no-referrer"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 bg-slate-950 p-6 md:p-8 border border-slate-850 rounded-3xl flex flex-col justify-between">
              ...
              <div className="pt-6 border-t border-slate-900 mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <a 
                  href={`${WHATSAPP_BASE}?text=I%20am%20exploring%20your%20SEO%20process%20at%20Step%20${processStep+1}.%20Let%27s%20discuss%20audit.`}
                  target="_blank"
                  referrerPolicy="no-referrer"
            ...
            {packageList.map((plan, idx) => (
              ...
              >
                ...
                <div className="pt-6 border-t border-slate-850/80 mt-6">
                  <a 
                    href={`${WHATSAPP_BASE}?text=I%20am%20requesting%20the%20${encodeURIComponent(plan.name)}%20for%20my%20domain.`}
                    target="_blank"
                    referrerPolicy="no-referrer"
            ...
            {auditSubmitted ? (
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4">
                  ...
                  <a 
                    href={`${WHATSAPP_BASE}?text=Hi%20AKGLS,%20I%20just%20submitted%20the%20Free%20SEO%20Audit%20for%20my%20domain%20called%20${encodeURIComponent(auditForm.website)}.%20Please%20accelerate.`}
                    target="_blank" 
                    referrerPolicy="no-referrer"
...
// Helper Component for WhatsApp icon representation
