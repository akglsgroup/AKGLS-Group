...
export default function HireAiSeoExpertPage({ onBackToHome, openProposalForm }: HireAiSeoExpertPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#02040d] text-slate-100 selection:bg-emerald-500/30 selection:text-emerald-300 font-sans antialiased overflow-x-hidden">
      ...
      <nav id="ai-seo-nav" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-between border-b border-slate-900/60 sticky top-0 bg-[#02040d]/85 backdrop-blur z-50">
        <button 
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-xs sm:text-sm text-slate-300">
                  Ready to capture conversational AI search traffic? Hire a <strong className="text-emerald-400">dedicated AI SEO Expert</strong> today.
                </p>
              </div>
              <div className="flex items-center gap-3">
                <a 
                ...
                <button 
                  onClick={() => {
                    const form = document.getElementById('free-ai-audit-stage');
