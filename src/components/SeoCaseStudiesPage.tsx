...
export default function SeoCaseStudiesPage({ onBackToHome, openProposalForm }: SeoCaseStudiesPageProps) {
  ...
  return (
    <div id="seo-case-studies-page" className="bg-[#030712] text-slate-300 min-h-screen relative font-sans leading-relaxed selection:bg-brand-orange selection:text-slate-950">
      ...
      <div id="sticky-header" className="bg-slate-950 border-b border-indigo-950/80 text-xs py-2 px-4 flex justify-between items-center z-20 relative font-mono">
      ...
      {/* HERO SECTION */}
      <section className="relative pt-6 pb-16 sm:pt-8 md:pt-10 md:pb-24 bg-[#040816] text-white overflow-hidden text-left border-b border-indigo-950/70">
