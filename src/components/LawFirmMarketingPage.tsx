...
export default function LawFirmMarketingPage({ onBackToHome, openProposalForm }: LawFirmMarketingPageProps) {
  ...
  return (
    <>
      ...
      {/* 👑 HERO SECTION */}
      <section className="relative pt-6 pb-16 sm:pt-8 md:pt-10 md:pb-24 text-left bg-[#05070c] border-b border-slate-950 overflow-hidden">
        {/* Top ambient highlight bridge */}
        <div className="absolute top-0 inset-x-0 h-24 bg-gradient-to-b from-amber-500/10 via-brand-teal/5 to-transparent pointer-events-none" />
        {/* Background elements */}
