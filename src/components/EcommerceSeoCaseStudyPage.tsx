...
export default function EcommerceSeoCaseStudyPage({ onBackToHome, openProposalForm }: EcommerceSeoCaseStudyPageProps) {
  ...
  return (
    <div className="bg-[#030712] text-slate-100 min-h-screen selection:bg-brand-orange selection:text-white">
      ...
      {/* Hero section */}
      <section className="relative pt-6 pb-16 sm:pt-8 md:pt-10 md:pb-24 overflow-hidden border-b border-slate-900 bg-linear-to-b from-brand-navy/60 via-slate-950 to-[#030712]">
        {/* Top ambient highlight bridge */}
        <div className="absolute top-0 inset-x-0 h-24 bg-gradient-to-b from-brand-orange/12 via-brand-navy/20 to-transparent pointer-events-none" />
