...
export default function ShopifyDevelopmentServicesPage({ onBackToHome, openProposalForm }: ShopifyDevelopmentServicesPageProps) {
  ...
  return (
    <div id="shopify-development-services-page" className="bg-[#03060a] text-slate-300 min-h-screen relative font-sans leading-relaxed selection:bg-brand-teal selection:text-slate-950">
      ...
      <section className="relative pt-6 pb-16 sm:pt-8 md:pt-10 md:pb-24 bg-[#03060a] text-white overflow-hidden text-left border-b border-slate-900">
        {/* Top ambient highlight bridge */}
        <div className="absolute top-0 inset-x-0 h-24 bg-gradient-to-b from-emerald-500/12 via-brand-teal/5 to-transparent pointer-events-none" />
